  ...
  return (
    <>
      ...
      <main className="mx-4 md:mx-[400px] bg-inherit md:shadow-lg">
        <h2 className="text-center text-2xl text-[#000000E6]">
          Join LinkedIn now - it&apos;free
        </h2>
        <form action="">
          <div className="mt-4">
          ...
          <div className="mt-8">
            <Button
              ...
              className="bg-[#0A66c2] text-white text-sm font-bold hover:transition hover:bg-[#004182]"
            >
              Continue
            </Button>
          </div>
        ...
        <div>
          ...
          <div className="mt-8 ">
            <Button className="w-full rounded-full py-[0.7rem] px-[1.4rem] bg-transparent border-[1px] border-slate-300 text-neutral-600 text-md font-normal flex items-center justify-center gap-2">
              <span>
          ...
          <div className="mt-8">
            <p className="text-center">
              ...
              <Link
                href="/signin"
                className="text-violet-900 font-normal active:bg-blue-50 active:rounded-sm active:underline"
              >
                Sign in
              </Link>
            </p>
          ...
          <div className="my-4">
            <p className="text-sm">
              ...
              <Link href="#" className="text-[#0A66c2] font-normal">
                Get help
              </Link>
            </p>
          </div>
