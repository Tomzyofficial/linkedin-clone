        ...
        <div>
          ...
          <div className="mt-8 relative">
            <button
              ...
              className="relative bg-transparent border-[1px] border-slate-300 text-neutral-600 text-md font-normal hover:transition hover:bg-gray-100"
            >
              <span className="absolute -translate-x-8">
                <Image src={googleIcon} sizes="10vw" alt="google icon"></Image>
              </span>
          ...
          <div className="mt-4">
            ...
            >
              <span className="absolute -translate-x-8">
                <Image src={appleImage} sizes="10vw" alt="google icon"></Image>
              </span>
              Sign in with Apple
            </button>
          </div>
          <div className="mt-4">
            <button
              ...
              className="bg-transparent border-[1px] border-slate-300 text-neutral-600 text-md font-normal hover:transition hover:bg-gray-100"
            >
              <span className="absolute -translate-x-8">
                <Image
                  src={oneTimeSignin}
